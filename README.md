# FasTE
FasTE is designed to be used as a quick user guide for *de novo* transposable element (TE) library generation and screening. It utilises two packages; the Extensive de novo TE Annotator (EDTA) and DeepTE which may be used in tandem for *de novo* TE annotation and classification.
